...
RSA_KEY = read('/PATH/TO/YOUR/RSA_CERT.pem')
#print("This is the key I read:\n")
#print(RSA_KEY)
#print("\n")


# The URLs for the JIRA instance
JIRA_SERVER = 'http://YOUR-JIRA-URL:PORT'
...
print("AccessTokenURL: " + ACCESS_TOKEN_URL + "\n\n")
...
print("Copy the following URL, and append the access token printed above -- visit it in a browser & accept:")
print("http://10.42.100.117:8080/plugins/servlet/oauth/authorize?oauth_token=PASTETOKENHERE")
